...
| **Current tree** | **v0.61.0** — Go `remedy-runtime` + Zig `remedy_core` own local API `:7400` and Desktop. Public: GitHub **[v0.61.0](https://github.com/AhmiDarrow/RemedyAI/releases/tag/v0.61.0)** · PyPI **`remedy-ai`** |
...
| [RemedyConnect](29-remedy-connect) | Phone remote for this PC (default off) |
