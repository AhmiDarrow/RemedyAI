...
| **Current** | **v0.22.2** on [PyPI](https://pypi.org/project/remedy-ai/) · [GitHub Releases](https://github.com/AhmiDarrow/RemedyAI/releases) |
...
**Latest: [v0.22.2](https://github.com/AhmiDarrow/RemedyAI/releases/tag/v0.22.2)** — Sleev dead-gateway fail-open (chat no longer stuck).
