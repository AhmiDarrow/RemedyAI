...
| **Current** | **v0.38.0** (this tree) · last public tag [v0.31.2](https://github.com/AhmiDarrow/RemedyAI/releases/tag/v0.31.2) · [PyPI](https://pypi.org/project/remedy-ai/) · [GitHub Releases](https://github.com/AhmiDarrow/RemedyAI/releases) |
...
**This tree: v0.38.0** — capability architecture (policy, credentials, verification, turn ids). Last public GitHub Release: [v0.31.2](https://github.com/AhmiDarrow/RemedyAI/releases/tag/v0.31.2). Partner line starts at [v0.31.0](https://github.com/AhmiDarrow/RemedyAI/releases/tag/v0.31.0).
