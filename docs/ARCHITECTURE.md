...
| Gateway | `native/go/gateway/` (+ thin `src/remedy/gateway/`) | Go owns messenger inbound (Telegram/Discord/Slack/Matrix/Mattermost) + poll locks; Python keeps catalog, settings, webhook/catalog helpers |
