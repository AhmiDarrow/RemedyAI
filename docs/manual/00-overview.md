...
| **Current tree** | **v0.62.0** — Go `remedy-runtime` + Zig `remedy_core` own local API `:7400` and Desktop. Public: GitHub **[v0.62.0](https://github.com/AhmiDarrow/RemedyAI/releases/tag/v0.62.0)** · PyPI **`remedy-ai`** |
