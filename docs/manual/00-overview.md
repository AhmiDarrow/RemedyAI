...
| **Current tree** | **v0.63.2** — Go `remedy-runtime` + Zig `remedy_core` own local API `:7400` and Desktop. Public: GitHub **[v0.63.2](https://github.com/AhmiDarrow/RemedyAI/releases/tag/v0.63.2)** · PyPI **`remedy-ai`** |
