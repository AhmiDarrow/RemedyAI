...
Ship **one** installer/tag for the current series (prefer latest **v0.10.37+**).

## 0.10.37 — Help wiki + report issue

- **In-app Help wiki** (this manual): **F1** / **Ctrl+/**, searchable TOC, offline chapters.
- Status bar **Help**, logo menu, Settings deep-links, Skills guide link.
- **Settings → About: Report an issue on GitHub** (version prefilled); Help footer too.
- `/help` command card points to the full wiki.
...
- Token bootstrap retries; corrupt config forces wizard again.
