...
# DeepSeek / Gemini / OpenRouter-non-Grok). Recall, job_run, and
# git_diff stay in the core so every provider can remember, verify,
# and review a patch while operating.
WORK_MAX_TOOLS_PER_STEP = 38
