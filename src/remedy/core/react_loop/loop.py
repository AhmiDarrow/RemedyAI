...
# ``loop_steps.run_react_steps`` resolves these on this module at call time so
# tests that patch ``remedy.core.react_loop.loop.<name>`` keep working.
_LOOP_STEPS_BINDINGS: tuple[object, ...] = (
    execute_tool_calls,
    LlmBinding,
    get_llm_binding,
    set_llm_binding,
