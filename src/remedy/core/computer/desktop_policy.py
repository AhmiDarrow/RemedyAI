"""Shared desktop policy (SoM / keys / shots / snapshot helpers).

Pure Python policy used by Windows siblings and the POSIX facade. Host I/O goes
through ``host_binding`` / ``remedy_core`` only — no ctypes twin, no pointer-tool
shellouts.
"""
