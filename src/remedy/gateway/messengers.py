...
MESSENGERS: tuple[MessengerDef, ...] = (
    ...
    MessengerDef(
        ...
        fields=(
            MessengerField("app_id", "App (client) ID", "text", required=True),
            MessengerField("app_password", "App password / secret", "secret", required=True),
            MessengerField("tenant_id", "Tenant ID", "text", help="Default botframework.com"),
            MessengerField("allow_ids", "Allowed conversation/user IDs", "list"),
            MessengerField("allow_all", "Allow all", "bool"),
        ),
    ),
    MessengerDef(
    ...
    MessengerDef(
        ...
        fields=(
            ...
            MessengerField("allow_ids", "Allowed space/user IDs", "list"),
            MessengerField("allow_all", "Allow all", "bool"),
        ),
    ),
    MessengerDef(
        ...
        fields=(
            ...
            MessengerField("account", "Account number", "text", "+1…", required=True),
            MessengerField("allow_from", "Allowed numbers", "list"),
            MessengerField("allow_all", "Allow all", "bool"),
        ),
    ),
)
