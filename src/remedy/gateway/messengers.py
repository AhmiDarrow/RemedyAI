...
MESSENGERS: tuple[MessengerDef, ...] = (
    ...
    MessengerDef(
        id="discord",
        name="Discord",
        description="Bot REST outbound; Gateway websocket inbound planned.",
        status="partial",
        inbound=False,
        outbound=True,
    ...
    MessengerDef(
        id="slack",
        name="Slack",
        description="chat.postMessage outbound; Socket Mode inbound planned.",
        status="partial",
        inbound=False,
        outbound=True,
        ...
        fields=(
            ...
            MessengerField(
                ...
                "Signing secret",
                "secret",
                help="For Events API verification (inbound).",
            ),
        ),
    ),
    MessengerDef(
        id="mattermost",
        name="Mattermost",
        description="Self-hosted team chat via REST API.",
        status="partial",
        inbound=False,
        outbound=True,
    ...
    MessengerDef(
        id="whatsapp",
        name="WhatsApp",
        description="Meta Cloud API (official). Business account required.",
        status="planned",
        inbound=False,
        outbound=False,
    ...
    MessengerDef(
        id="matrix",
        name="Matrix",
        description="Matrix client-server API (planned).",
        status="planned",
        inbound=False,
        outbound=False,
        ...
        fields=(
            ...
            MessengerField("access_token", "Access token", "secret", required=True),
            MessengerField("user_id", "User ID", "text", "@bot:example.com"),
