...
# WhatsApp / Teams / Google Chat HTTP inbound (/api/webhooks/*) is owned by
# Go remedy-runtime — see native/go/httpapi/webhooks_test.go. Python FastAPI
# no longer registers those routes (TestClient twin removed).
