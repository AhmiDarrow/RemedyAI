...
def test_turn_kind_life_vs_code():
    ...
    assert turn_kind("launch the site locally so I can see the new remedy page") == "code"
    assert turn_kind("start the server and open the preview") == "code"
    assert turn_kind("open the home page") == "code"
    assert turn_kind("change the font-family") != "life"
